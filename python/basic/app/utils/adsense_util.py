...
# client_secret.
CLIENT_SECRETS_FILE = "client_secret_594452767494-s259766fta2uq7t3etvo23b9s9jpl936.apps.googleusercontent.com.json"
...
def get_adsense_credentials(overwrite_existing_credentials=False):
    ...
    credentials = None
    if (
        os.path.isfile(CREDENTIALS_FILE)
        and not overwrite_existing_credentials
